...
#         string="Pickup Point",
#         required=True,
#         help="Pickup point for which bins will be selected.",
#     )
#
#     container_ids = fields.Many2many(
#         'waste.container',
#         'waste_assign_bin_wizard_line_container_rel',  # relation table
#         'line_id',
#         'container_id',
#         string="Bins",
...
#                " ('customer_id', '=', False),"
#                " ('status', 'in', ('intact', 'un_use'))]",
#         help="Only bins that are not assigned to any pickup point/customer and are available.",
#     )
...
#         'container_id',
#         string="Bins",
#         domain="[('pickup_point_id', '=', pickup_point_id)]",
#         help="Bins at this pickup point.",
#     )
