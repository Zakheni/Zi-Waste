...
class ResCompany(models.Model):
    ...
    #
    #         # ✅ Allow system admins normally
    #         if user.has_group('base.group_system'):
    #             new_vals_list.append(vals)
    #             continue
    #
    #         # ✅ Allow only your module users
    ...
    #
    #     # 👉 Call original create (VERY IMPORTANT)
    ...
    #     for vals in vals_list:
    #
    #         # ✅ Admin → normal behavior
    #         if user.has_group('base.group_system'):
    #             new_vals_list.append(vals)
    #             continue
    #
    #         # ✅ Allowed WMZ users → force branch
    #         if user.has_group('waste_management_zakheni.group_wmz_admin') or \
    #                 user.has_group('waste_management_zakheni.group_wmz_admin_clerk'):
    #
    #             vals['parent_id'] = user.company_id.id
    ...
    #     companies = super().create(new_vals_list)
    #
    #     # 🔥 SECOND SAFETY (because of precommit hook)
    #     for company in companies:
    ...
    # ------------------------------------------------------------
    # BLOCK ACCOUNTING FOR BRANCHES (CLEAN FIX)
    # ------------------------------------------------------------
    # def _load_default_accounts(self, *args, **kwargs):
    #     for company in self:
    #         if company.is_branch:
    #             return  # 🚫 Skip accounting setup
    #     return super()._load_default_accounts(*args, **kwargs)
