"""Fleet vehicle extensions for waste haulage."""
from odoo import models, fields, api, _
from odoo.exceptions import UserError, AccessDenied, ValidationError
import psycopg2

class FleetVehicle(models.Model):
    """Trucks and trailers with driver assignment and tank volume."""
    ...
    def create(self, vals_list):
        """Set waste-specific defaults on fleet vehicle create."""
        try:
...
class FleetVehicleModel(models.Model):
    """Vehicle model extensions for waste fleet."""
