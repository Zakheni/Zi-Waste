"""Product template and SO line extensions for waste catalogues."""
from odoo import models, fields, api, _
from odoo.exceptions import ValidationError


class ProductTemplate(models.Model):
    """Extended product configuration for waste services."""
...
class SaleOrderLine(models.Model):
    """Additional fields on sale lines for waste products."""
