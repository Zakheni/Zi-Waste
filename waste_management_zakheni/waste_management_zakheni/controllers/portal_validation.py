"""Portal account form validation for international phone numbers."""
...
class PortalAccountPhoneValidation(CustomerPortal):
    """Validate E.164 phone format on /my/account."""

    @http.route(['/my/account'], type='http', auth='user', website=True, methods=['GET', 'POST'])
    def account(self, **post):
        """Validate phone format on portal account update before saving."""
