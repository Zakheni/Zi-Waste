# -*- coding: utf-8 -*-
"""HTTP controller to export the waste dashboard as XLSX."""
import io
import json
import urllib.parse
...
class WasteDashboardExportController(http.Controller):
    """Build and download dashboard spreadsheets."""
    ...
    def export_dashboard_xlsx(self, filters=None, **kw):
        """HTTP endpoint that streams the dashboard as an XLSX file."""
        # 1) decode filters
        filters = filters or "{}"
        try:
