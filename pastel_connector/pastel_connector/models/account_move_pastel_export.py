"""Account move extension: export posted customer invoices to Sage Pastel."""
...
class AccountMove(models.Model):
    """Add UI action to export selected invoices to Sage via pastel.sync."""

    _inherit = "account.move"

    def action_export_to_sage(self):
        """Export posted customer invoices/credit notes to Sage and notify the user."""
