"""Transient form to trigger selective imports from Sage Pastel."""
...
class PastelImportForm(models.Model):
    """Wizard-style form to import customers, products, invoices, or suppliers."""
    ...
    def _notify(self, title, msg, level="success"):
        """Return a client notification action for the UI."""
        return {
    ...
    def action_import_customers(self):
        """Import customers only from Sage and store the result summary."""
        self.ensure_one()
    ...
    def action_import_products(self):
        """Import products only from Sage and store the result summary."""
        self.ensure_one()
    ...
    def action_import_invoices(self):
        """Import sales invoices only from Sage and store the result summary."""
        self.ensure_one()
    ...
    def action_import_now(self):
        """Import entities selected via the form checkboxes."""
        self.ensure_one()
    ...
    def action_import_all(self):
        """Force import of customers, products, invoices, and suppliers."""
        self.ensure_one()
