...
app = FastAPI(title="Pastel Partner Bridge (RETIRED — use sage_bridge)")

import logging as _logging
_logging.getLogger("pastel_partner_bridge").warning(
    "This process is retired. Stop it and run sage_bridge on 127.0.0.1:8788. See sage_bridge/docs/INSTALL.md"
)
